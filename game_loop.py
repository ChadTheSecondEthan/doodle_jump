...
def start(s):
    global background, screen, player, cam, floors, prev_time, lose_text, lose_text_pos, font, replay_text, replay_text_pos
    ...
    floors.append(Floor((variables.SCREEN_SIZE[0] - floor.W) / 2, player.y + 100))
...
def update_lose():
    score_text_pos = (variables.SCREEN_SIZE[0] - score_text.get_size()[0]) / 2, 50 + (variables.SCREEN_SIZE[1] - score_text.get_size()[1]) / 2
